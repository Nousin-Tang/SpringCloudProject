...
public class DB2JavaCodeUtil {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/cloud_storage?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&useSSL=false&serverTimezone=UTC";
    ...
    public static void main(String[] args) {
        try {
            String pkg = "com.nousin.springcloud.server.storage";// 生成文件存在方的包
            String path = getProjectPath() + "src/main/java/" + pkg.replace(".", "/") + "/temp/";// 生成文件存放的路径
